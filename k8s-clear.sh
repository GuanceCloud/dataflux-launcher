...
kubectl delete configmaps func-config func-inner-config func-worker-config  -n func
...
kubectl delete deployments func func-inner func-worker-beat func-worker-debugger func-worker-rpc-crontab func-worker-utils -n func
...
kubectl delete services func func-inner func-worker-beat func-worker-debugger func-worker-rpc-crontab func-worker-utils -n func
...
kubectl delete ingress func -n func

# 清理 PVC
kubectl delete PersistentVolumeClaim ft-sysconfig -n forethought-core
