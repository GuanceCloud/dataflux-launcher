...
kubectl delete deployments message-desk message-desk-worker-beat message-desk-worker nsqadmin nsqlookupd nsqd -n middleware --force --grace-period=0
...
kubectl delete services message-desk message-desk-worker-beat message-desk-worker nsqadmin nsqlookupd nsqd -n middleware --force --grace-period=0
...
kubectl delete PersistentVolumeClaim  message-desk-logs message-desk-worker-logs nsqd-data-1 -n middleware --force --grace-period=0
