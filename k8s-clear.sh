...
kubectl delete deployments message-desk message-desk-worker-beat message-desk-worker -n middleware --force --grace-period=0
...
kubectl delete services message-desk message-desk-worker-beat message-desk-worker -n middleware --force --grace-period=0
...
kubectl delete PersistentVolumeClaim  message-desk-logs message-desk-worker-logs -n middleware --force --grace-period=0
