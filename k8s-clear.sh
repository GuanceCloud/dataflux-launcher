...
# 清理 PVC
kubectl delete PersistentVolumeClaim ft-sysconfig front-backend-logs inner-logs management-backend-logs integration-scanner-logs -n forethought-core --force --grace-period=0
