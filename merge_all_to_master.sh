...
workDir=$(pwd)
allProject="cloudcare-forethought-backend cloudcare-forethought-webclient cloudcare-forethought-setup cloudcare-forethought-webmanage kodo dataflux-func dataflux-doc message-desk message-desk-worker screenhot-server jfr-parser pprofparser"
